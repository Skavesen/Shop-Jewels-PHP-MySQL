...
<p align="center"><b>ПРОСМОТР ЗАПИСЕЙ КАТЕГОРИЙ С РАЗБИВКОЙ ПО СТРАНИЦАМ</b></p>
...
*/
        ...
        echo "<p><a href='viewcategories.php'>Просмотреть все</a> | <b>Просмотреть страницу:</b> ";
        for ($i = 1; $i <= $total_pages; $i++)
        {
                echo "<a href='viewcategories-paginated.php?page=$i'>$i</a> ";
        }
        echo " | <a href='newcategory.php'>Введите новую категорию</a></p>";
        ...
        for ($i = $start; $i < $end; $i++)
        {
				...
				echo '<td><a href="editcategory.php?id=' . mysql_result($result, $i, 'mmenu_id') . '">Изменить</a></td>';
				echo '<td><a href="deletecategory.php?paginated=yes&id=' . mysql_result($result, $i, 'mmenu_id') . '">Удалить</a></td>';
				echo "</tr>";
        }
        // close table>
        echo "</table>"; 
