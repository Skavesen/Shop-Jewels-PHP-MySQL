...
<p align="right"><a href="index-1.php">Домашняя страница</a> | <a href="logout.php">Выйти</a></p>
<p align="center"><img src="image/logo.png" /></p>
<p align="center"><b><u>Квитанция о подтверждении заказа</u></b></p>
...
<p align="left"><b> Дата : <?php echo $date;?></b></p>
...
<table border="0" width="auto">
	...
	<tr>
		<td width="25%"><strong>Имя</strong></td>
		<td width="3%"><b>:</b></td>
	...
	<tr>
	  <td width="25%"><strong>Адрес для выставления счета</strong></td>
	  <td width="3%"><b>:</b></td>
	  <td width="auto"><?php echo $address; ?></td>
	</tr>
	
	<tr>
	  <td width="25%"><strong>Телефон</strong></td>
	  <td width="3%"><b>:</b></td>
...
<tr>
	...
	<td align="left"><font face="monotype corsiva"><b>Общее количество</b></font></td>
	<td align="center"><?php echo $totalquantity;?></td>
</tr>

<tr>
	<td align="left"><b>Всего товаров</b></td>
	<td align="center"><?php echo $rows;?></td>
</tr>

<tr>
	<td align="left"><b>Промежуточный итог</b></td>
	<td align="center"><?php echo $subtotal;?></td>
</tr>

<tr>
	<td align="left"><b>НДС (15%)</b></td>
	<td align="center"><?php echo $vat;?></td>
</tr>

<tr>
	<td align="left"><b>Стоимость доставки</b></td>
...
<tr>
	<td align="left"><b>Общая сумма(Руб)</b></td>
...
<br />
<center>
<p>ЭТО СЛУЖИТ ВАШЕЙ ОФИЦИАЛЬНОЙ КВИТАНЦИЕЙ</p>
<p>БЛАГОДАРИМ ВАС ЗА ВЫБОР BB JEWELLERY</p>
<p><b>ПРИМЕЧАНИЕ. Ожидайте подтверждения по телефону перед доставкой.</b></p>
</center>
