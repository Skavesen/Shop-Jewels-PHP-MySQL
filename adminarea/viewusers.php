...
<p align="center"><b>ПРОСМОТР ЗАПИСЕЙ ПОЛЬЗОВАТЕЛЕЙ</b></p>
...
*/
        ...
        echo "<p><b>Просмотреть все</b> | <a href='viewusers-paginated.php?page=1'>Просмотр с разбивкой по страницам</a> | <a href='newuser.php'>Добавьте новую запись</a></p>";
        ...
        while($row = mysql_fetch_array( $result )) {	
			...
			echo '<td><a href="edituser.php?id=' . $row['user_id'] . '">Изменить</a></td>';
			echo '<td><a href="deleteuser.php?paginated=no&id=' . $row['user_id'] . '">Удалить</a></td>';
			echo "</tr>"; 
		}
