...
<p align="center"><b><u>ВСЕ КУПЛЕННЫЕ ТОВАРЫ</u></b></p>
...
<p align="left"><b> ДАТА : <?php echo $today;?></b></p>
...
<table border="0" width="auto">
	...
	<tr>
		<td width="25%"><strong>Покупатель</strong></td>
		<td width="3%"><b>:</b></td>
	...
	<tr>
	  <td width="25%"><strong>Адрес</strong></td>
	  <td width="3%"><b>:</b></td>
...
<?php
	...
	else
	{
		echo "<table align='center' cellspacing='1' cellpadding='0' width='80%'>
				...
				<th align='center' bgcolor='e6e6e6'>ДАТА</th>
				<th align='center' bgcolor='e6e6e6'>КОД ТРАНЗАКЦИИ</th>
				<th align='center' bgcolor='e6e6e6'>ID</th>
				<th align='center' bgcolor='e6e6e6'>НАЗВАНИЕ</th>
				<th align='center' bgcolor='e6e6e6'>КОЛИЧЕСТВО</th>
				<th align='center' bgcolor='e6e6e6'>ЦЕНА</th>
...
<center>
<p><b>БЛАГОДАРИМ ВАС ЗА ВЫБОР BB JEWELLERY<b></p>
</center>
</body>
</html>