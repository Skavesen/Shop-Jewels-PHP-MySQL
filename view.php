...
<div id="wrapper">
	...
	<!--Middle Part End-->
		...
		<div class="box-heading-1"><span>ПРОСМОТР ПРОДУКТОВ</span></div>
			<div class="box-content-1">
				<div class="box-product-1" >
					...
					<?php
						...
						while($row = mysqli_fetch_array($query, MYSQLI_ASSOC))
						{
							...
							$list .='
								...
								<table border="1" bordercolor="#FF0000" cellpadding="15">
									<tr><td><b>Название</b><td>' . $prodname . '</td></tr>
									<tr><td><b>Картинка</b></td><td><img width="' . $width . '" height="' . $height . '" src="' . $src . $path . '" alt = "' . $prodname . '"></td></tr>';
								 $list .='
									<tr><td><b>Описание</b></td><td>' . $desc . '</<td></tr>
						...
						echo "<b>Количество просмотров: </b> <font size='5px'> <font face='monotype corsiva'>" .  $noviews . "</font></font>";
					...
					?>
						...
						if (T > 100)
						{
						alert("To order more than 100 contact BB JEWELS")
						document.forms[0].elements[0].focus();
						return false;
						}
						return true;
						...
						<?php echo $list;?>
						Введите количество:<input type="text" name="txtQty" size="8" onkeypress="return checkIt(event)">
