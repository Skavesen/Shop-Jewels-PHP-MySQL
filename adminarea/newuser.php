...
<head>
<meta charset="UTF-8">
<title>НОВАЯ СТРАНИЦА ПОЛЬЗОВАТЕЛЯ</title>
...
<p align="center"><b>ДОБАВЛЕНИЕ ПОЛЬЗОВАТЕЛЯ</b></p>
    ...
    <td colspan="5" height="96">
        ...
        <tr>
            <td bgColor="c6d3ce">
              <table width="400" border="0">
                ...
                <tr bgColor="e7efef">
                  <td>Фамилия</td>
                  <td><b><input type="text" size="25" name="Surname" onkeypress="acceptw()"></b></td>
				</tr>
                <tr bgColor="e7efef">
                  <td>Логин</td>
				...
				<tr bgColor="e7efef">
                  <td>Телефон</td>
                  <td><b><input type="text" size="10" maxlength="8" name="Tel" onKeypress="if (event.keyCode < 45 || event.keyCode > 57) event.returnValue = false;"></b></td>
				</tr>				
				<tr bgColor="dee7e7">
                  <td>Тип аккаунта</td>
        ...
        <table width="400" align="center" border="0">
          <tr>
            ...
            <td align="center" width="200"><input type="reset" name="reset" value="Очистить" onClick="return confirm('Вы уверены, что хотите удалить текущую информацию?');"></td> </tr>
        </table>
      </form>
    </td>
  </tr>
