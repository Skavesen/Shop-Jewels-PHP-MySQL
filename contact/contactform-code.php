...
<div id='fg_formContainer'>
    <div id="fg_container_header">
        <div id="fg_box_Title">Связаться с нами</div>
        <div id="fg_box_Close"><a href="../default.php" onClick="javascript:fg_hideform('fg_formContainer','fg_backgroundpopup');">Выйти(X)</a></div>
    </div>
    ...
    <div><img alt='Captcha image' src='show-captcha.php?rand=1' id='scaptcha_img' /></div>
        <label for='scaptcha' >Введите код с капчи:</label>
        <input type='text' name='scaptcha' id='scaptcha' maxlength="10" /><br/>
        <span id='contactus_scaptcha_errorloc' class='error'></span>
        <div class='short_explanation'>Не можете прочитать изображение??
        <a href='javascript: refresh_captcha_img();'>Нажмите здесь, чтобы обновить</a>.</div>
    </div>
...
// <![CDATA[
    ...
    frmvalidator.addValidation("message","maxlen=2048","Сообщение слишком длинное! (более 2 КБ!)");

    frmvalidator.addValidation("scaptcha","req","Пожалуйста, введите код на изображении выше");
