...
<div id="wrapper">
	...
	<!--Middle Part End-->
		...
		<div class="box mb0" id="featured">
			<div class="box-heading-1"><span>Избранное</span></div>
					...
					<?php
						...
						if($last != 1){
							...
							if ($pagenum > 1) {
								$First = $pagenum == 1;
								$previous = $pagenum - 1;
								$paginationCtrls .= '<a href="'.$_SERVER['PHP_SELF'].'?pn=1'.$First.'">Первая</a> &nbsp; &nbsp; ';
								$paginationCtrls .= '<a href="'.$_SERVER['PHP_SELF'].'?pn='.$previous.'">Предыдущая</a> &nbsp; &nbsp; ';
							...
							if ($pagenum != $last) {
								$next = $pagenum + 1;
								$paginationCtrls .= ' &nbsp; &nbsp; <a href="'.$_SERVER['PHP_SELF'].'?pn='.$next.'">Следующая</a> &nbsp; &nbsp; ';
								
								$Last = $last;
								
								$paginationCtrls .= '<a href="'.$_SERVER['PHP_SELF'].'?pn='.$Last.'">Последняя</a>';
							}
						}
						$list = '';
						...
						{
							echo "<blockquote><h2>" . $textline1 . " товаров</h2></blockquote>";
