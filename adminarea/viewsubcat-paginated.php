...
<p align="center"><b>ПРОСМОТР ЗАПИСЕЙ ПОДКАТЕГОРИЙ С РАЗБИВКОЙ ПО СТРАНИЦАМ</b></p>
...
*/
        ...
        echo "<p><a href='viewsubcat.php'>Просмотреть все</a> | <b>Просмотреть страницу:</b> ";
        for ($i = 1; $i <= $total_pages; $i++)
        {
                echo "<a href='viewsubcat-paginated.php?page=$i'>$i</a> ";
        }
        echo " | <a href='newsubcat.php'>Добавить новую подкатегорию</a></p>";
        ...
        for ($i = $start; $i < $end; $i++)
        {
				...
				echo '<td><a href="editsubcat.php?id=' . mysql_result($result, $i, 'id') . '">Редактировать</a></td>';
				echo '<td><a href="deletesubcat.php?paginated=yes&id=' . mysql_result($result, $i, 'id') . '">Удалить</a></td>';
				echo "</tr>";
        }
        // close table>
        echo "</table>"; 
