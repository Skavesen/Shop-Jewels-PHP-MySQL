...
<header id="headerWrapper">
	<div id="header">
		...
		<!-- Mini Cart Start-->
		<div id="cart">
			<div class="heading"><a href="cart.php"><span id="cart-total"><?php echo $countrows;?> товар(ов) - Руб. <?php echo $totalamount;?></span></a></div>
			
		</div>
		<!-- Mini Cart End-->
			<?php
			// Display Username
			echo '<div id="welcome"> Приветствую <b>' . $User . '</b> || <a href="logout.php">Выйти</a></div>';
			?>
	</div>
