...
<div id="wrapper">
	...
	<!--Middle Part End-->
		...
		<div class="box-heading-1"><span>КОРЗИНА</span></div>
			<div class="box-content-1">
				<div class="box-product-1" >
					<?php
						...
						else
						{
							...
							echo '<table align="center" border="1" cellspacing="1" cellpadding="0" width="75%">
									<th align="center" bgcolor="e6e6e6">ID</th><th align="center" bgcolor="e6e6e6">НАЗВАНИЕ</th>
									<th align="center" bgcolor="e6e6e6">КОЛИЧЕСТВО</th><th align="center" bgcolor="e6e6e6">ЦЕНА</th>
									<th align="center" bgcolor="e6e6e6">ЦЕНА ПОКУПКИ</th>
									<th align="center" bgcolor="e6e6e6" colspan="2">ОБНОВИТЬ КОЛИЧЕСТВО</th>
									<th align="center" bgcolor="white">ДАТА</th>
									<th align="center"><font color="red">УДАЛИТЬ</font></th>';
					...
					<table border="1" align="center" width="300px">
						<tr align="center">
							<td width="150px"><font face="monotype corsiva"><b>Количество</b></font></td><td width="150px"><?php echo $totalquantity;?></td>
						</tr>
						<tr align="center">
						...
						<tr align="center">
							<td><b>Стоимость доставки</b></td><td><?php echo $delivery;?></td>
						</tr>
						<tr align="center">
					...
					<p align="center"><b>ПРИМЕЧАНИЕ. Все цифры округлены.</b></p>

					<?php
					 if(!$rows == 0)
					 {
					?>
					<p align="center"><input type="button" value="Оформить заказ" onClick="javascript:location.href='checkout.php';"></p>
					<?php
					 }
					?>
				</div>
